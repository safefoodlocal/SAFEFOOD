...
export default function Header() {
  ...
  return (<header className={isScrolled ? 'header scrolled' : 'header'}><div className="container nav">
    ...
    <nav className={isOpen ? 'links open' : 'links'}>
      ...
      <a href="https://wa.me/201022863304" target="_blank" rel="noopener noreferrer" aria-label="Contact us on WhatsApp" className="whatsapp-nav-link">
        <svg viewBox="0 0 24 24" fill="currentColor" className="whatsapp-icon-svg">
